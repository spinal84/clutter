...
https://wiki.gnome.org/GTK%2B/Win32/MSVCCompilationOfGTKStack
...
build-aux/win32/vs10/README.txt in the GLib source package for details
...
CRTs-please see also the build-aux/win32/vs10/README.txt in those respective
packages.
...
-(optional for GLib) PCRE (8.12 or later, building PCRE using CMake is
 recommended-please see build-aux/win32/vs10/README.txt in the GLib source package)
